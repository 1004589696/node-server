 ...
 * 新建抽奖
 */
router.post('/add', passport.authenticate('bearerPC', {session: false}), function (req, res, next) {
  var data = req.body;
 ...
 * 抽奖列表
 */
router.get('/list', passport.authenticate('bearerPC', {session: false}), function (req, res, next) {
 ...
 * 抽奖查询
 */
router.get('/detail', passport.authenticate('bearerPC', {session: false}), function (req, res, next) {
  var id = req.query.id;
 ...
 * 抽奖编辑
 */
router.put('/edit', passport.authenticate('bearerPC', {session: false}), function (req, res, next) {
  var id = req.query.id;
  var data = req.body;
 ...
 * 抽奖上下架
 */
router.put('/effect', passport.authenticate('bearerPC', {session: false}), function (req, res, next) {
  var id = req.query.id;
...
router.post('/:lucydrawId', passport.authenticate('bearer', {session: false}), function (req, res, next) {
